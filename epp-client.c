...
static int error_translator[][2] =
{
  ...
  {ccReg_poll_msgID,            errspec_pollAck_msgID},
  {ccReg_poll_msgID_missing,    errspec_pollAck_msgID_missing},
  {ccReg_contact_handle,     errspec_contactCreate_handle},
  {ccReg_contact_cc,         errspec_contactCreate_cc},
  {ccReg_contact_handle,       errspec_contactInfo_handle},
  {ccReg_contact_cc,         errspec_contactUpdate_cc},
  {ccReg_contact_identtype_missing, errspec_contactUpdate_identtype_missing},
  {ccReg_nsset_handle,       errspec_nssetCreate_handle},
  {ccReg_nsset_tech,         errspec_nssetCreate_tech},
  {ccReg_nsset_dns_name,      errspec_nssetCreate_ns_name},
  {ccReg_nsset_dns_addr,      errspec_nssetCreate_ns_addr},
  {ccReg_nsset_handle,         errspec_nssetInfo_handle},
  {ccReg_nsset_dns_name_add,  errspec_nssetUpdate_ns_name_add},
  {ccReg_nsset_dns_addr,  errspec_nssetUpdate_ns_addr_add},
  {ccReg_nsset_dns_name_rem,  errspec_nssetUpdate_ns_name_rem},
  {ccReg_nsset_dns_addr,  errspec_nssetUpdate_ns_addr_rem},
  {ccReg_nsset_tech_add,     errspec_nssetUpdate_tech_add},
  {ccReg_nsset_tech_rem,     errspec_nssetUpdate_tech_rem},
  {ccReg_domain_fqdn,        errspec_domainCreate_fqdn},
  {ccReg_domain_registrant,  errspec_domainCreate_registrant},
  {ccReg_domain_nsset,       errspec_domainCreate_nsset},
  {ccReg_domain_period,      errspec_domainCreate_period},
  {ccReg_domain_admin,       errspec_domainCreate_admin},
  {ccReg_domain_ext_valDate, errspec_domainCreate_ext_valDate},
  {ccReg_domain_fqdn,          errspec_domainInfo_fqdn},
  {ccReg_domain_fqdn,         errspec_domainRenew_fqdn},
  {ccReg_domain_curExpDate,   errspec_domainRenew_curExpDate},
  {ccReg_domain_period,       errspec_domainRenew_period},
  {ccReg_domain_ext_valDate,  errspec_domainRenew_ext_valDate},
  {ccReg_domain_fqdn,        errspec_domainUpdate_fqdn},
  {ccReg_domain_registrant,  errspec_domainUpdate_registrant},
  {ccReg_domain_nsset,       errspec_domainUpdate_nsset},
  {ccReg_domain_admin_add,   errspec_domainUpdate_admin_add},
  {ccReg_domain_admin_rem,   errspec_domainUpdate_admin_rem},
  {ccReg_domain_ext_valDate, errspec_domainUpdate_ext_valDate},
